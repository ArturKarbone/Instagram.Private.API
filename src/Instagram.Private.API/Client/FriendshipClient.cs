...
namespace Instagram.Private.API.Client
{
    public class FriendshipClient
    {
        ...
        protected async Task<FollowersResponse> Followers(Account account, string next_max_id = "")
        {
        ...
        public IEnumerable<FollowersResponse> FollowersCursor(Account account)
        {
